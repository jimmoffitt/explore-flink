...
def stream_events(csv_filepath="your_data.csv", timestamp_column="datetime", speedup_factor=1.0, row_id_column_name="row_id"):
    try:
...
if __name__ == "__main__":
    csv_file = './input/vodclickstream_uk_movies_03_2018.csv'
